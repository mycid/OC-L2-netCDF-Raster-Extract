...
project_name <- "OC_L2_RasterExtract" # adapt!
...
files <- list.files(path=paths, pattern = ".nc$", full.names = FALSE)
if(length(files)==0){
...
## Use wrapper function to extract from multiple files  
```{r, echo=TRUE, message=FALSE, warning=FALSE}
...
lintr::lint("scripts/Extract_Rasterize.R")
```
## Flagging
Flags and meaning
